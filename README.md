...
- Addressed missing data by applying appropriate techniques such as creating new columns where necessary and using Excel functions to fill out numeric data.
